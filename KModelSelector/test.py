import  KModelSelector.kmodelselector
...
k = KModelSelector.kmodelselector.KModelSelector()

k.RunExperiments(Tag="ImageClassification",X=train_x,Y=train_y,features=features,num_classes=num_classes)
